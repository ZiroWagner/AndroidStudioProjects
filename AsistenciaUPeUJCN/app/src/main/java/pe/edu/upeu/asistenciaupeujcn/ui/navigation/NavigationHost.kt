...
import pe.edu.upeu.asistenciaupeujcn.ui.presentation.screens.*
import pe.edu.upeu.asistenciaupeujcn.ui.presentation.screens.login.LoginScreen

@RequiresApi(Build.VERSION_CODES.O)
@Composable
fun NavigationHost(navController: NavHostController, darkMode: MutableState<Boolean>, modif: PaddingValues) {
    NavHost(
        ...
        composable(Destinations.Pantalla1.route) {
            Pantalla1(navegarPantalla2 = {
                    newText -> navController.navigate(Destinations.Pantalla2.createRoute(newText))
                }
            )
        }
